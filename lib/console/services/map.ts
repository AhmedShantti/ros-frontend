...
export function toOrderLine(row: WireOrderLine, currency: Currency): OrderLine {
  ...
  return {
    ...
    modifierTotal: minorMoney(row.modifierTotal, currency),
    lineDiscount: minorMoney(row.lineDiscount, currency),
    lineSubtotal: minorMoney(row.lineSubtotal, currency),
    taxAmount: minorMoney(row.taxAmount, currency),
    lineTotal: minorMoney(row.lineTotal, currency),
    unitCostSnapshot: minorMoney(row.unitCostSnapshot, currency),
...
export function toOrder(row: WireOrder, context: OrderContext): Order {
  ...
  return {
    ...
    servedByName: null,
    currency,
    subtotal: minorMoney(row.subtotal, currency),
    discountTotal: minorMoney(row.discountTotal, currency),
    serviceChargeTotal: minorMoney(row.serviceChargeTotal, currency),
    taxTotal: minorMoney(row.taxTotal, currency),
    roundingAdjustment: minorMoney(row.roundingAdjustment, currency),
    grandTotal: minorMoney(row.grandTotal, currency),
    paidTotal: minorMoney(row.paidTotal, currency),
    tipTotal: minorMoney(row.tipTotal, currency),
